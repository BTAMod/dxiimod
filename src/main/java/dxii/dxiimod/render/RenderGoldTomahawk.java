...
public class RenderGoldTomahawk extends EntityRenderer<EntityGoldTomahawk> {

	public RenderGoldTomahawk(){ this.shadowSize = 0.1f; }

	@Override
	public void doRender(Tessellator tessellator, EntityGoldTomahawk entity, double x, double y, double z, float f, float f1) {
		float scale = .4f;
		int rot = entity.customRot;
		this.loadTexture("/assets/dxiimod/textures/entity/tomahawk_gold.png");
		GL11.glPushMatrix();
