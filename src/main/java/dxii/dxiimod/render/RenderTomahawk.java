...
public class RenderTomahawk extends EntityRenderer<EntityTomahawk> {

	public String texture = "/assets/dxiimod/textures/entity/tomahawk_stone.png";
	...
	@Override
	public void doRender(Tessellator tessellator, EntityTomahawk entity, double x, double y, double z, float f, float f1) {
		float scale = .4f;
		int rot = entity.customRot;
		this.loadTexture(entity.texture);
		GL11.glPushMatrix();
