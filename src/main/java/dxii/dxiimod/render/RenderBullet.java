...
public class RenderBullet extends EntityRenderer<EntityBullet> {
	...
	public RenderBullet(){ this.shadowSize = 0.1f; }

	@Override
	public void doRender(Tessellator tessellator, EntityBullet entity, double x, double y, double z, float f, float partialTick) {
		float scale = .2f;
