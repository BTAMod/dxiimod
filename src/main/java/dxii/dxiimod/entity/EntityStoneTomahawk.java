...
public class EntityStoneTomahawk extends EntityProjectile{
	public int customRot;
	public boolean playerCreative = false;

	public EntityStoneTomahawk(World world, EntityLiving entityliving, boolean playerCreative) {
	...
	public void onHit(HitResult hitResult) {
		if (hitResult.hitType == HitResult.HitType.TILE) {
			if(!playerCreative) {
				EntityItem item = new EntityItem(this.world, this.x, this.y, this.z, new ItemStack(modItems.stoneTomahawk, 1));
