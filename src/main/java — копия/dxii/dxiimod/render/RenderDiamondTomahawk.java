...
public class RenderDiamondTomahawk extends EntityRenderer<EntityDiamondTomahawk> {

	public RenderDiamondTomahawk(){ this.shadowSize = 0.1f; }

	@Override
	public void doRender(Tessellator tessellator, EntityDiamondTomahawk entity, double x, double y, double z, float f, float f1) {
		float scale = .4f;
		int rot = entity.customRot;
		this.loadTexture("/assets/dxiimod/textures/entity/tomahawk_diamond.png");
		GL11.glPushMatrix();
