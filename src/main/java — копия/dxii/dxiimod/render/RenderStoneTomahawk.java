...
public class RenderStoneTomahawk extends EntityRenderer<EntityStoneTomahawk> {

	public RenderStoneTomahawk(){ this.shadowSize = 0.1f; }

	@Override
	public void doRender(Tessellator tessellator, EntityStoneTomahawk entity, double x, double y, double z, float f, float f1) {
		float scale = .4f;
		int rot = entity.customRot;
		this.loadTexture("/assets/dxiimod/textures/entity/tomahawk_stone.png");
		GL11.glPushMatrix();
