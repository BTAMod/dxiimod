...
public class modItems{
	...
	public void Initialize() {
		...
		stoneHammer = new ItemBuilder(dxiimodMain.MOD_ID).setIcon(dxiimodMain.MOD_ID + ":item/hammer_stone").setItemModel(item -> new ItemModelStandard(item, dxiimodMain.MOD_ID).setFull3D()).build(new hammerStoneItem("STONE_HAMMER", 12005) );
		ironHammer = new ItemBuilder(dxiimodMain.MOD_ID).setIcon(dxiimodMain.MOD_ID + ":item/hammer_iron").setItemModel(item -> new ItemModelStandard(item, dxiimodMain.MOD_ID).setFull3D()).build(new hammerIronItem("IRON_HAMMER", 12006) );
		goldHammer = new ItemBuilder(dxiimodMain.MOD_ID).setIcon(dxiimodMain.MOD_ID + ":item/hammer_gold").setItemModel(item -> new ItemModelStandard(item, dxiimodMain.MOD_ID).setFull3D()).build(new hammerGolditem("GOLD_HAMMER", 12007) );
		steelHammer = new ItemBuilder(dxiimodMain.MOD_ID).setIcon(dxiimodMain.MOD_ID + ":item/hammer_steel").setItemModel(item -> new ItemModelStandard(item, dxiimodMain.MOD_ID).setFull3D()).build(new hammerSteelItem("STEEL_HAMMER", 12008) );
